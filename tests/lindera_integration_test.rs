...
mod lindera_integration_tests {
    ...
    fn test_direct_lindera_indexing() {
        ...
        writer
            .add_document(doc!(
                title => "田中さんの出社日",
                body => "田中さんの出社日について確認します。基本的に平日はSlack OK。"
            ))
            .unwrap();
        ...
        // Test 2: Search for "田中さん"
        println!("\nTest 2: Searching for '田中さん'");
    ...
    fn test_search_manager_with_content() {
        ...
        let bookmarks = vec![
            FlatBookmark {
                id: "1".to_string(),
                name: "田中さんの出社日について確認します。基本的に平日はSlack OK。".to_string(),
            ...
            FlatBookmark {
                id: "2".to_string(),
                name: "明日の会議は田中さんも参加予定です。".to_string(),
        ...
        println!("Search for '田中 出社': found {} results", results.len());
        ...
        println!("Search for '田中さん': found {} results", results.len());
        assert_eq!(results.len(), 2, "Should find 2 results for '田中さん'");
    }
}
